...
public class Sample {
	...
	// temporarily store all information from the Leap Motion controller
	...
	/** method */
	/*
	 * Expect replacement only. In general, we don't modify the sampling frames.
	 * We prefer to record samples again
	 */
