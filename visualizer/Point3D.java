...
/**
 *
 * @author Sean I have been done some modification for this program use.
...
public class Point3D {
	...
	public Point3D midpoint(Point3D point) {
		return midpoint(point.x, point.y, point.z);
	}

	public Point3D midpoint(float x, float y, float z) {
	...
	public Point3D crossProduct(float x, float y, float z) {
		return new Point3D(-this.z * y + this.y * z, this.z * x - this.x * z, -this.y * x + this.x * y);
	}
